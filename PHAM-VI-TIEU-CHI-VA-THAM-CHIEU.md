...
**Quyết định cuối** (= MIN của 3 tầng, xem chi tiết [gate-rules.md](gate-rules.md) §Logic quyết định cuối):

| Decision | Tầng 1 (Hard Gate) | Tầng 2 (Score Gate) | Tầng 3 (Severity Gate) |
|----------|---------------------|---------------------|------------------------|
| **READY** | PASS | MIN ≥ 90% và mọi trục ≥ 80% | 0 P0 và ≤3 P1 |
| **READY WITH NOTES** | PASS | MIN 80–89% và mọi trục ≥ 80% | 0 P0 và ≤7 P1; hoặc P1 4–7 hạ 1 mức |
| **NEEDS REWORK** | PASS | Bất kỳ trục < 80% | 0 P0 và >7 P1 |
| **BLOCKED** | FAIL bất kỳ H1–H11 | — (không tính) | ≥1 P0 mở |

> **Lưu ý**: Mỗi tầng cho ra 1 decision riêng. Quyết định cuối = giá trị **thấp nhất** (BLOCKED < NEEDS REWORK < READY WITH NOTES < READY). Ví dụ: Score Gate = READY nhưng Severity Gate = BLOCKED (có P0) → cuối = BLOCKED.
